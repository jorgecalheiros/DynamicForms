...
export function RepeaterForm({ schema, onSubmit: onSubmitProp, className }: RepeaterFormProps) {
  ...
  return (
    <>
      <div className={`bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden${className ? ` ${className}` : ''}`}>
        {/* Header */}
